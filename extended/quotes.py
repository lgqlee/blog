...
"Always do rightthis will gratify some and astonish the rest."-Mark Twain (1835-1910)
...
"There are only two ways to live your life. One is as though nothing is a miracle. The other is as though everything is a miracle."-Albert Einstein (1879-1955)""".splitlines()


def generate():
    return random.choice(__qoute_list)
